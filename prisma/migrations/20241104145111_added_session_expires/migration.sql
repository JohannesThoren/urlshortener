/*
  ...
  - Added the required column `session_exipres` to the `admin` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_admin" (
    ...
    "session_exipres" DATETIME NOT NULL
);
